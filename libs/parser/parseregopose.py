...
def parse_arg():
    ...
    parser.add_argument('-linear_size', type=int, default=2048)
    ...
    parser.add_argument('-twoD_source', type=str, default='HRN')
    ...
    parser.add_argument('-evolved_path', type=str,
                        default=None)
    # parser.add_argument('-evolved_path', type=str, default="/media/zlz422/4c5bc93a-b9bd-41e4-9c3e-f713d29f31a3/jyt/EvoSkeleton/data/generation_6.npy")
    ...
    parser.add_argument('-lr', type=float, default=0.01, help="sgd: 0.5, adam: 0.001")
