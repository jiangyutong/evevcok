...
#
#     print(">>> data loaded !")
#     loss_test, err_mean, err_bestsamp, _, _ = test_multiposenet(test_loader, model, criterion, stat_3d, stat_2d,
...
def load_data(filepath):
    ...
    return x
a=load_data("/root/data/xR-ego-resized/TrainSet/female_003_a_a/env_003/cam_down/json/female_003_a_a_005000.json")
a=load_data("/root/data/xR-ego-resized/TrainSet/female_003_a_a/env_003/cam_down/json/female_003_a_a_000500.json")
print("")